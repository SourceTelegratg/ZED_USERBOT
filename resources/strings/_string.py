...
C = "**⌔╎المعادله ⪼** {}\n  **- الحل ⪼** {}"
Calc = (
    "𓆰 𝗦𝗢𝗨𝗥𝗖𝗘 𝘼𝙇𝙍𝘼𝘿 ⩫ - 𝑪𝑨𝑳𝑪𝑼𝑳𝑨𝑻𝑶𝑹 𓆪\n"
    "◐━─━─━─━─**𝘼𝙇𝙍𝘼𝘿**─━─━─━─━◐\n"
    "**⌔╎قائـمه اوامر الحاسبه :** \n"
    "⪼ `.حاسبه` + المعادله \n"
    "◐━─━─━─━─**𝘼𝙇𝙍𝘼𝘿**─━─━─━─━◐\n"
    "𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝘼𝙇𝙍𝘼𝘿 - [𝘿𝙀𝙑](t.me/ALRADTHEN) 𓆪"
)
...
⫷ بوت الواعد ثون يعمل بنجاح الان ⫸
   ⫷ المستخدم: {} - البوت: {} ⫸
...
Echo = [
    ...
    '𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝘼𝙇𝙍𝘼𝘿𝙏𝙃𝙀𝙉 - 𝑬𝑪𝑯𝑶 𝑳𝑰𝑺𝑻 𓆪\n◐━─━─━─━─**𝘼𝙇𝙍𝘼𝘿𝙏𝙃𝙀𝙉**─━─━─━─━◐\n**⌔╎قائمة المضافين للازعاج:**\n',
    '**- ايدي المستخدم :** `{}`\n**- ايدي الـمجموعه :** `{}`\n\n',
